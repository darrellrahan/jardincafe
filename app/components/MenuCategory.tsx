...
function MenuCategory() {
  return (
    <section id="menu-category">
      <div className="px-32 py-16 grid grid-cols-2 gap-8 rounded-t-[2.5rem] -mt-16 z-20 relative bg-white">
        {menuCategory.map((data) => (
          ...
          >
            ...
            <a
              href={data.link}
              className="w-[10.5rem] bg-white text-[#013300] rounded-[0.625rem] px-4 py-3 text-lg flex justify-between items-center z-10 font-medium border-2 border-white hover:bg-transparent hover:text-white duration-200 ease-linear"
            >
              <span>FIND MORE</span>
