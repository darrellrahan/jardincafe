  ...
  return (
    <section id="booking">
      <div className="h-screen bg-[url('/images/booking/bg.png')] bg-no-repeat bg-cover relative flex items-center">
        ...
        <div className="shadow-[4px_4px_4px_rgba(255,255,255,0.4)] w-[46.875rem] bg-white rounded-[0.625rem] py-10 mx-auto z-10 flex flex-col items-center text-center">
          ...
          <div className="grid grid-cols-1 gap-6 mt-6">
            <div className="flex gap-4">
              ...
              <div className="relative after:absolute after:right-5 after:font-light after:top-2.5 after:content-['>'] after:rotate-90 after:text-4xl after:text-[#013300]">
                <select
                  onChange={(e) =>
                    setSelectValue({ ...selectValue, people: e.target.value })
                  }
            ...
            <div className="flex gap-4">
              ...
              <div className="relative after:absolute after:right-5 after:font-light after:top-2.5 after:content-['>'] after:rotate-90 after:text-4xl after:text-[#013300]">
                <select
                  onChange={(e) =>
                    setSelectValue({ ...selectValue, time: e.target.value })
                  }
                  className={`cursor-pointer appearance-none w-[18.75rem] h-[3.75rem] border-2 border-[#013300] rounded-[0.625rem] flex items-center px-4 font-medium text-lg ${
                    selectValue.time === ""
                      ? "text-[#a9a9a9]"
            ...
            <div className="flex gap-4">
              ...
              <div className="relative after:absolute after:right-5 after:font-light after:top-2.5 after:content-['>'] after:rotate-90 after:text-4xl after:text-[#013300]">
                <select
                  onChange={(e) =>
                    setSelectValue({ ...selectValue, area: e.target.value })
                  }
                  className={`cursor-pointer appearance-none w-[18.75rem] h-[3.75rem] border-2 border-[#013300] rounded-[0.625rem] flex items-center px-4 font-medium text-lg ${
                    selectValue.area === ""
                      ? "text-[#a9a9a9]"
            ...
            <button className="text-lg font-medium h-[3.75rem] border-2 border-[#013300] bg-[#013300] rounded-[0.625rem] text-white hover:text-[#013300] hover:bg-transparent duration-300 ease-linear">
              See Detail
            </button>
          </div>
        </div>
